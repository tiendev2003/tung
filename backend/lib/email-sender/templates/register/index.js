    ...
    <div style="background-color:#f2f3f8; padding-bottom:100px;">
      ...
      >
                      ...
                      <tr>
                        ...
                        >
                          ...
                          >
                            ...
                            <p>Verify your email address to complete the signup and login into your <strong>Shop Fashion</strong> account.
                            </p>
        ...
        <p style="margin-bottom:20px;">Click this link for active your account</p></p>
                             ...
                             <a href=${process.env.STORE_URL}/verify-email/${option.token} style="background:#22c55e;color:white;border:1px solid #22c55e; padding: 10px 15px; border-radius: 4px; text-decoration:none;">Verify Account</a>

                            <p style="margin-top: 35px;">If you did not initiate
                              this request, please contact us immediately at
                              trancongtien406@gmail.com</p>
